...
set VK_APIDUMP_LOG_FILENAME=C:\Wafflecat\spatial_progression\SpatialProgression\TestCube\apidump_wite.txt
..\x64\Debug\TestCube.exe
set VK_APIDUMP_LOG_FILENAME=C:\Wafflecat\spatial_progression\SpatialProgression\TestCube\apidump_baseline.txt
