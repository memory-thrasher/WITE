...
//   ArbitrarySizeQueue::ArbitrarySizeQueue(bool makeThreadSafe, size_t allocationBlockSize, size_t initialBlockCount) : threadSafe(makeThreadSafe) {
//     WITE::Util::ScopeLock ctxlock(threadSafe ? &lock : NULL);
